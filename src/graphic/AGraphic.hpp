...
namespace graphic {
    class AGraphic : public IGraphic {
            public:
                ...
                virtual void readSetGame(std::queue<std::tuple<EventType, eventData>> &event) final;
                virtual void readSetGraphic(std::queue<std::tuple<EventType, eventData>> &event) final;
